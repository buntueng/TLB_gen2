        ...
        try:
            if main_state == 0:
                ...
                if time.ticks_ms()-main_state_timer >= 800:
                    ...
                    main_state_timer = time.ticks_ms()
                    main_state = 32
                if time.ticks_ms() - main_state_timer >= 650:
                    on_solenoid1()
                    on_solenoid3()
            elif main_state == 32:
                ...
                if time.ticks_ms() - main_state_timer >= 30:
                    sliding_motor.active(0)
                    set_sliding_forward()
                    main_state = 41
                resp_flag = False
            ...
            #===================== stop silo =============================        
                ...
                if time.ticks_ms() - main_state_timer >= 250: #100
                    stop_silo()
                    on_solenoid1()
                    main_state_timer = time.ticks_ms()
                    main_state = 15
