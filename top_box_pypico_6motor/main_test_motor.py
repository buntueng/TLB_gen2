...
silo1_dir_pin = Pin(26,Pin.OUT)
silo2_dir_pin = Pin(20,Pin.OUT)
silo3_dir_pin = Pin(17,Pin.OUT)
silo4_dir_pin = Pin(15,Pin.OUT)
#========== Enable pin ======================
silo1_ENB_pin = Pin(28,Pin.OUT)
silo2_ENB_pin = Pin(22,Pin.OUT)
silo3_ENB_pin = Pin(19,Pin.OUT)
silo4_ENB_pin = Pin(16,Pin.OUT)
#===============================================
...
silo1_motor = rp2.StateMachine(0, run_silo1_motor, freq=200000, set_base=Pin(27))      # GPIO16 => pulse, GPIO17 => direction
silo2_motor = rp2.StateMachine(1, run_silo2_motor, freq=200000, set_base=Pin(21))      # GPIO18 => pulse, GPIO19 => direction
silo3_motor = rp2.StateMachine(2, run_silo3_motor, freq=200000, set_base=Pin(18))      # GPIO18 => pulse, GPIO21 => direction
silo4_motor = rp2.StateMachine(3, run_silo4_motor, freq=200000, set_base=Pin(14))      # GPIO18 => pulse, GPIO27 => direction
#========== sub functions ==========
